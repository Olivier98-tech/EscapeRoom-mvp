...
const ER = (() => {
  ...
  const INTROS = {
    ...
    4: { title: "Level 4 — Code van de Vier",
         text: "De dataversleuteling is gekraakt. Voorbij deze deur ligt de AI-controlekamer, beveiligd met een symbolencode. De juiste volgorde ligt in de fysieke kluis — kraak de kluiscode om hem te bemachtigen. 🚨 Alarmfase actief." },
